...
const AddDesign  = ({ existingProduct, RefreshData, subCategories, onClose, userData, categories, brands }) => {
    ...
    // const AddDesign Data = async (data) => {
    //     try {
    //         setLoading(true);
    ...
    //         const endpoint = existingProduct?._id ? `/editProduct/${existingProduct._id}` : '/AddDesign ';
